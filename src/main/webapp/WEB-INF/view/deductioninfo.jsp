				...
				<div class="user-list" id="user_list">
					...
					<div class="user-table">
						...
						<div class="form-fields">
							<form:form name="validation" modelAttribute="deductionInfoForm"
								role="form" action="/saveDeductionInfo" method="post"
								...
								<!--  <div class="form-group">
                                      <div>
                                        <label for="basic salary" class="lable-name">Employee Number * </label>
                                         <select class="input-name" name="employeenumber" style="height: 30px;">
								...
								<div class="form-group">
									<div>
										<label for="emailid" class="lable-name">80CCD -
											...
											type="text" class="input-name" id="ccd" name="ccd"
											required="" />
