...
public class EmployeeCommand {
	...
	public String toString() {
		return "EmployeeCommand [employeenumber=" + employeenumber + ", name=" + name + ", geder=" + geder + ", bday="
				+ bday + ", pan=" + pan + ", maritalstatus=" + maritalstatus + ", email=" + email + ", phone=" + phone
				+ ", password=" + password + ", doornum=" + doornum + ", vlg=" + vlg + ", mandal=" + mandal
				+ ", country=" + country + ", state=" + state + ", district=" + district + ", pin=" + pin
