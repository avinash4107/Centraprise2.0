					...
					<div class="top-nav">
						...
						<div class="tile_count">
							...
							<div class="col-md-2 col-sm-4 col-xs-6 title_stats_count">
								...
								<a href="user_list.php"><div class="count green"></div> </a>
							</div>
							<div class="col-md-2 col-sm-4 col-xs-6 title_stats_count">
								<div class="count_center">
									<i class="fa fa-users"></i> Groups
								</div>
								<a href="groups.php"><div class="count green"></div></a>
							</div>
							<div class="col-md-2 col-sm-4 col-xs-6 title_stats_count">
								<div class="count_bottom">
							...
							<div class="col-md-2 col-sm-4 col-xs-6 title_stats_count">
								<div class="count_center">
									<i class="fa fa-phone"></i> Extensions
								</div>
								<a href="user_list.php"><div class="count green"></div></a>
							</div>
							...
							<div
								...
								<a href="user_location.php"><div class="count green"></div></a>
							</div>
					...
					<div class="user-table">
						...
						<div class="form-fields">
							<form:form name="validation" role="form"
								modelAttribute="employeeForm" action="/addemployee"
								...
								<div class="form-group">
									<div>
										<label class="lable-name">Gender * </label> Men: <input
											type="radio" name="gender" /> Women: <input type="radio"
											name="geder" /> Transgender: <input type="radio"
											name="gender" />
									</div>
								</div>
								...
								<div class="form-group">
									<div>
										<label class="lable-name">Marital Status * </label> Married: <input
											type="radio" name="maritalstatus" /> Single: <input
